import sublime, sublime_plugin, os, re, sublime_rails_go_to_sass.resolver

class RailsGoToSassCommand(sublime_plugin.WindowCommand):
    def run(self):
        win = self.window
        ...
        related_files = sublime_rails_go_to_sass.resolver.Resolver().run(current_file)
